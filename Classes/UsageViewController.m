...
-(IBAction)rankClicked:(UIView*)sender {
	...
	switch (searched) {
		case 0:
			rankName = @"eMAILsearch Newbie";
			break;
		case 25:
			rankName = @"eMAILsearch Explorer";
			break;
		case 50:
			rankName = @"eMAILsearch Commander";
			break;
		case 75:
			rankName = @"eMAILsearch Captain";
			break;
		case 100:
			rankName = @"eMAILsearch Superstar";
			break;
	}
