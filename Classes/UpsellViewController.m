...
-(void)viewWillAppear:(BOOL)animated {
	...
	[self.recommendButton setTitle:NSLocalizedString(@"Recommend eMAILsearch", nil) forState:UIControlStateNormal];
	[self.recommendButton setTitle:NSLocalizedString(@"Recommend eMAILsearch", nil) forState:UIControlStateSelected];
	[self.recommendButton setTitle:NSLocalizedString(@"Recommend eMAILsearch", nil) forState:UIControlStateHighlighted];
	
	self.descriptionLabel.text = NSLocalizedString(@"This feature lets you connect multiple Gmail accounts to eMAILsearch", nil);
	self.howToActivateLabel.text = NSLocalizedString(@"How to Activate", nil);
	self.featureFreeLabel.text = [NSString stringWithFormat:NSLocalizedString(@"You can activate this functionality by recommending eMAILsearch to %i of your friends.", nil),
